...
for constraint_name in constraint_names:
    for epsilon in epsilons:
        ...
        parse_trees = make_parse_trees_from_constraints(
            ...
            sub_regime=sub_regime, columns=sensitive_attr)
        ...
        spec_save_name = os.path.join(save_dir, f'lie_detection_{constraint_name}_{epsilon}.pkl')
